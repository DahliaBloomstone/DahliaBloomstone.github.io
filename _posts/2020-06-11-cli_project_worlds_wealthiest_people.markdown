...
I FINALLY FIXED IT! AFTER WORKING ON THIS ALL DAY! with the help of a friend on slack, we figured out: that I needed another method in my cli to separate the descriptions from the rankings. YAY! 

It is now: class WorldsWealthiestPeople::CLI
